...
pub fn map_mouse(button: SdlMouseButton, raw: u32, pressed: bool) -> IcedMouseEvent {
...
pub fn map_window(event: SdlWindowEvent) -> Option<IcedEvent> {
...
pub fn map_key_code(key_code: SdlKeyCode) -> Option<IcedKeyCode> {
...
pub fn map_modifier(modifier: SdlKeyModifier) -> IcedKeyModifier {
